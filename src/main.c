 ...
 *
 * Ported to Hack Club Sprig using YouMakeTech/Pico-GB as base.
 * LCD driver: ST7735_TFT.h from Sprig firmware (bablokb/pic-st7735 lineage).
 *
 * Sprig pin mapping
 * -----------------
 ...
 *   L  = GP15  -> GB A
 *
 * LCD ST7735 on SPI0 (handled inside ST7735_TFT.h / st7735_init):
 *   MOSI=GP19, SCK=GP18, MISO=GP16, CS=GP20, DC=GP22, RST=GP26, BL=GP17
 *
 * SD card on SPI0 (same bus, separate CS):
